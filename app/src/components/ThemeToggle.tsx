  ...
  return (
    ...
    >
      <path
        ...
        className={twMerge(
          'data-selected:fill-sky-500 fill-slate-400 dark:fill-slate-500',
          config.theme?.['theme.icon.fill'] ?? ''
        )}
      />
      <path
        ...
        data-is-selected={selected ? 'true' : 'false'}
        className={twMerge(
          'data-selected:stroke-sky-500 stroke-slate-400 dark:stroke-slate-500',
          config.theme?.['theme.icon.stroke'] ?? ''
        )}
      />
    </svg>
  )
          ...
          >
            {({ active, selected }) => (
              <li
                ...
                className={twMerge(
                  'py-1 px-2 flex items-center cursor-pointer data-selected:text-sky-500 hover:bg-slate-50 dark:hover:bg-slate-700',
